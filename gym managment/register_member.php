...
require_once 'fpdf/fpdf.php';//vaka ja vklucuvame pdf
...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    //prvo ja vklucuvame pdf pred da ja koristime -> gore u required_once e vtoroto
     $pdf = new FPDF();
     $pdf->AddPage();
    ...
    $sql = "UPDATE members SET access_card_pdf_path = '$filename' WHERE memer_id = $member_id";
    $conn->query($sql);
    $conn->close();



    $_SESSION['success_message']= 'Clenot na teretana uspesno e dodaden';
